...
def github():
    ...
    token = os.environ.get(
        'GITHUB_TOKEN', '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')
    GITHUB_URL = f"https://api.github.com/"
    print("API Call by Shikha")
    headers = {
   ...
   #GET branches DATA
    ...
    for i in range(1):
        ...
        print("Noyal query_url: ",query_url)
        # requsets.get will fetch requested query_url from the GitHub API
    ...
    # prod https://forecasting-errbrsi3ga-uc.a.run.app/
